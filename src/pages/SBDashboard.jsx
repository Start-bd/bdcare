...
const services = [
    ...
    { icon: FlaskConical, bn: 'ল্যাব টেস্ট', en: 'Lab Test', color: 'bg-purple-100 text-purple-600', page: 'Hospitals' },
    { icon: Heart, bn: 'প্যাকেজ', en: 'Packages', color: 'bg-pink-100 text-pink-600', page: 'SBDoctors' },
